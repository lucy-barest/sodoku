...
public class LinkedListTests { 
    public static void main(String[] args) {
        ...
        // case 12: testing offer, peek, and poll
        {
            ...
            System.out.println(newList.peek() + " == 5");
            newList.poll();
            System.out.println(newList.peek() + " == 4");
            newList.poll();
            System.out.println(newList.peek() + " == 3");
        }

        System.out.println("Done testing LinkedList!");

        // case 13: testing peek, poll, and push
        {
            LinkedList<Integer> newList = new LinkedList<Integer>();
            ...
            System.out.println(newList.peek() + " == 1");
            System.out.println(newList.poll() + " == 1");
            newList.poll();
            System.out.println(newList.peek() + " == 3");
